...
mod tests {
    ...
    fn test_refresh_mana_restores_available_mana() {
        ...
        crate::game::user_actions::play_spell::play_spell(&mut game,player_a, refresh_spell, None).unwrap();
    ...
    fn test_multiple_refreshes_stack_capped_at_max_mana() {
        ...
        crate::game::user_actions::play_spell::play_spell(&mut game,player_a, multi_refresh_spell, None).unwrap();
        game.compute_commands().unwrap();
