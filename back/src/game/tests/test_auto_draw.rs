...
mod tests {
    ...
    fn test_auto_draw_respects_hand_limit() {
        ...
        crate::game::user_actions::play_monster::play_monster(&mut game,player_a, monster, 0, None).unwrap();
        game.compute_commands().unwrap();
    ...
    fn test_drawing_from_empty_deck_has_no_effect() {
        ...
        let result = crate::game::user_actions::end_turn::end_turn(&mut game,player_a);
